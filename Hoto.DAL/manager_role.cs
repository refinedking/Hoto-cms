...
namespace Hoto.DAL
{
    ...
    public partial class manager_role
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Hoto.Model.manager_role GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            Hoto.Model.manager_role model = new Hoto.Model.manager_role();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    List<Hoto.Model.manager_role_value> models = new List<Hoto.Model.manager_role_value>();
                    Hoto.Model.manager_role_value modelt;
                    for (int n = 0; n < i; n++)
                    {
                        modelt = new Hoto.Model.manager_role_value();
