...
namespace Hoto.DAL
{
    ...
    public partial class user_oauth
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from dt_user_oauth");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into dt_user_oauth(");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@oauth_access_token", SqlDbType.NVarChar,100),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dt_user_oauth set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from dt_user_oauth ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,user_id,user_name,oauth_name,oauth_access_token,oauth_openid,add_time from dt_user_oauth ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 id from dt_user_oauth");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" FROM dt_user_oauth ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM dt_user_oauth");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
