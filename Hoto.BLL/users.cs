...
namespace Hoto.BLL
{
    ...
    public partial class users
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Hoto.Model.users GetModel(int id)
        {
        ...
        public bool Upgrade(int id)
        {
            ...
            if (result > 0)
            {
                ...
                {
                    new BLL.amount_log().Add(model.id, model.user_name, HotoEnums.AmountTypeEnum.SysGive.ToString(), groupModel.amount, "升级赠送金额", 1);
                }
            }
            return true;
        }
