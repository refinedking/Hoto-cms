...
namespace Hoto.API.OAuth
{
    public class sina_helper
    {
        ...
        public static Dictionary<string, object> get_access_token(string code)
        {
            ...
            string param = "grant_type=authorization_code&code=" + code + "&client_id=" + config.oauth_app_id + "&client_secret=" + config.oauth_app_key + "&redirect_uri=" + HotoUtils.UrlEncode(config.return_uri);
            //发送并接受返回值
