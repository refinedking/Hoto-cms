...
namespace Hoto.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected DataTable get_app_oauth_list(int top, string strwhere)
        {
            ...
            return new Hoto.BLL.app_oauth().GetList(top, "is_lock=0", "sort_id asc,id desc").Tables[0];
        }
        ...
        {
            return new Hoto.BLL.user_message().GetCount(strwhere);
        }
        ...
        {
            return new Hoto.BLL.user_message().GetList(top, strwhere, "sort_id asc,post_time desc").Tables[0];
        }
        ...
        {
            return new Hoto.BLL.user_message().GetList(page_size, page_index, strwhere, "is_read asc,post_time desc", out totalcount).Tables[0];
        }
        ...
        {
            return new Hoto.BLL.point_log().GetList(page_size, page_index, strwhere, "add_time desc,id desc", out totalcount).Tables[0];
        }
        /// <summary>
        /// 余额明细分页列表
        /// </summary>
        ...
        {
            return new Hoto.BLL.amount_log().GetList(page_size, page_index, strwhere, "add_time desc,id desc", out totalcount).Tables[0];
        }
        ...
        {
            string _where = "type='" + HotoEnums.CodeEnum.Register.ToString() + "'";
            if (!string.IsNullOrEmpty(strwhere))
            {
                _where += " and " + strwhere;
            }
            return new Hoto.BLL.user_code().GetList(top, _where, "add_time desc,id desc").Tables[0];
        }
        /// <summary>
        /// 返回邀请码状态
        /// </summary>
