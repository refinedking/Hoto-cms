...
namespace Hoto.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        {
            Hoto.BLL.category bll = new Hoto.BLL.category();
        ...
        {
            return new Hoto.BLL.category().GetList(parent_id, channel_id);
        }
        ...
        {
            return new Hoto.BLL.category().GetChildList(parent_id, channel_id);
        }
